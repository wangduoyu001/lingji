...
from src.assistant_hub import AiAssistantDiscoveryService, AssistantImportPlanner
...
def register_capture_routes(app: Any, settings: Any, control: Any, *, token: str) -> None:
    ...
    def selected_file_payload(request: AssistantSelectedFileImportRequest) -> dict[str, Any]:
        ...
        return {
            ...
            "process_later": True,
            "metadata": {
                "origin": "assistant_autopilot_selected_file",
    ...
    def assistant_hub_authorize_candidate(
        ...
        try:
            ...
            payload = {
                ...
                "process_later": True,
                "metadata": {
                    "origin": "assistant_autopilot_discovered_candidate",
                    "owner_authorized": True,
