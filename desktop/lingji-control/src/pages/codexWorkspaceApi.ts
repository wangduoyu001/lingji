...
export class CodexWorkspaceApi {
  ...
  context(body: { project_id: string; query: string; session_id?: string; max_chars: number }, signal?: AbortSignal) { return this.api.post<ContextPack>("/api/context/project", body, { signal }); }
}
