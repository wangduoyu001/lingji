...
for (const token of ["NAVIGATION", "useLingJiConnection", "OverviewPage", "SystemComputePage", "ModelsPage", "SettingsPage", "AcceptancePage"]) {
...
for (const token of ["系统与算力", "AI 与模型", "环境验收", "设置", "主动投喂", "媒体分析"]) {
