...
assert.match(page, /项目/); assert.match(page, /项目对话/); assert.match(page, /尚未绑定项目/);
assert.match(dashboard, /\/api\/work\/current/); assert.match(dashboard, /OWNER WORK FACT/); assert.match(dashboard, /当前没有进行中的工作/);
